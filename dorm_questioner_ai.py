...
openai.api_key = os.getenv("OPENROUTER_API_KEY") or "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"
...
def ask_ai_dormitories():
    try:
        ...
        # Detect requested cities (exact filter)
        ...
        for dorm in dorms:
            # Only include dorms in requested cities (exact filter)
            if user_cities:
